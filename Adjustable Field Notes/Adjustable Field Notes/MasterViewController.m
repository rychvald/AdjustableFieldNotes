...
- (void)viewDidLoad
{
    ...
    self.itemInputController = [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"ItemInputController"];
}
...
- (void)insertNewObject:(id)sender
{
    ...
    [self.itemInputController prepareForNewEntry];
